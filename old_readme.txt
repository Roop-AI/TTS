...
if [[ "$OSTYPE" = "darwin"* ]]; then
    CONDA_URL="https://repo.anaconda.com/archive/Anaconda3-latest-MacOSX-x86_64.sh"
else
    CONDA_URL="https://repo.anaconda.com/archive/Anaconda3-latest-Linux-x86_64.sh"
fi

CONDA_INSTALLER="/tmp/anaconda3-latest.sh"
